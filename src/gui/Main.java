...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Untitled (1080 x 1350 px).png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/a-modern-and-minimalist-logo-representin_jv4DylowSY2IGO1pPgoo5Q_hO-zW58LQ3i99DQHsCAEoQ (2).jpeg"))); // NOI18N
        ...
        textPassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 255), 2));

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));

        jTextField1.setFont(new java.awt.Font("High Tower Text", 1, 48)); // NOI18N
        jTextField1.setText("Connexion");
        ...
        textLogin.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 255), 2));
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/a-modern-and-minimalist-logo-representin_jv4DylowSY2IGO1pPgoo5Q_hO-zW58LQ3i99DQHsCAEoQ (2).jpeg"))); // NOI18N
            ...
            if (user != null) {
                ...
                if (securityAnswer != null && !securityAnswer.isEmpty()) {
                    ...
                    if (userService.resetPasswordBySecurityQuestion(login, securityAnswer)) {
                        ...
                        JOptionPane.showMessageDialog(this, "Un nouveau mot de passe a été envoyé à votre e-mail.");
                    } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String password = new String(txtPassword.getPassword()).trim();
        ...
        if (userService.authenticate(login, password)) {
            ...
            JOptionPane.showMessageDialog(this, "Login ou mot de passe est incorrect");
        }
